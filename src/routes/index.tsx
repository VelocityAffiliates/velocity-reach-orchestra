...
const services = [
  ...
  { n: "03", t: "Event RSVP Campaigns", d: "Invites, confirmations, reminder cadence, and post-event follow-through built into the call workflow." },
  ...
  { n: "06", t: "Sales Process Support", d: "CRM organization, follow-up systems, accountability cadences, and reporting your team will actually use." },
];
...
function Home() {
  return (
    <div>
      ...
      {/* HERO */}
      <section className="container-x pt-40 pb-28 md:pt-56 md:pb-40">
        <span className="eyebrow">Outbound Execution Partner</span>
        <h1 className="mt-8 max-w-5xl font-display text-5xl md:text-7xl leading-[1.02]">
        ...
        <div className="mt-10 flex flex-wrap gap-3">
          ...
          <Link to="/services" className="btn-outline">See what we run</Link>
        </div>
      </section>

      {/* STATS */}
      <section className="container-x pb-24 md:pb-32">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10 border-t border-border pt-12">
      ...
      <section className="surface-subtle border-y border-border">
        <div className="container-x py-24 md:py-32 grid md:grid-cols-12 gap-12">
          <div className="md:col-span-5">
            ...
            <h2 className="mt-6 text-4xl md:text-5xl">You already paid for the pipeline.</h2>
          </div>
      ...
      <section className="container-x py-24 md:py-32">
        <div className="grid md:grid-cols-2 gap-px bg-border hairline rounded-2xl overflow-hidden">
          <div className="bg-background p-10 md:p-12">
            <span className="eyebrow">What Velocity Is</span>
        ...
        <div className="container-x py-24 md:py-32">
          <div className="flex flex-wrap items-end justify-between gap-6">
            <div>
              ...
              <h2 className="mt-6 text-4xl md:text-5xl max-w-2xl">
                Structured human outreach, run as infrastructure.
              </h2>
            </div>
            <Link to="/services" className="link-arrow">All services →</Link>
          </div>
          <div className="mt-14 grid md:grid-cols-2 lg:grid-cols-3 gap-px bg-border hairline rounded-xl overflow-hidden">
            {services.map((s) => (
      ...
      <section className="container-x py-24 md:py-32">
        ...
        <h2 className="mt-6 text-4xl md:text-5xl max-w-2xl">Simple. Strategic. Scalable.</h2>
        <div className="mt-16 grid md:grid-cols-3 gap-px bg-border hairline rounded-xl overflow-hidden">
          {[
            ...
            <div key={step.s} className="bg-background p-10">
              <div className="text-xs uppercase tracking-[0.22em] text-muted-foreground">{step.s}</div>
              <h3 className="mt-4 text-3xl">{step.t}</h3>
              <p className="mt-4 text-muted-foreground leading-relaxed">{step.d}</p>
            </div>
          ))}
        </div>
        <p className="mt-10 text-sm text-muted-foreground">Campaigns typically launch within two weeks of onboarding.</p>
      </section>
      ...
      <section className="border-y border-border surface-subtle">
        <div className="container-narrow py-24 md:py-32 text-center">
          ...
          <blockquote className="mt-8 font-display text-3xl md:text-4xl leading-snug">
            “Brooke and her team became an indispensable extension of our sales team. They built
            urgency, qualified serious buyers, and delivered ready-to-act prospects and agents.
            We surpassed projections months ahead of schedule.”
          </blockquote>
          <div className="mt-10 text-xs uppercase tracking-[0.22em] text-muted-foreground">
            Cathy Grant
          </div>
        </div>
      </section>
